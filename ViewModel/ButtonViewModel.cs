namespace Viewmodel
{
    ...
    public class ButtonViewModel : ViewModelBase
    {
        ...
        keyCMD.OperationRegistry registry;
        public ButtonViewModel()
        {
            registry = new keyCMD.OperationRegistry();
            ...
            (
                  () =>
                  {
                      DisplayText = keyCMD.OperationRegistry.GetOperation(keyCMD.OperationType.Equal).Execute(DisplayText);
                  }
            );
            ...
            (
                  () =>
                  {
                      DisplayText = keyCMD.OperationRegistry.GetOperation(keyCMD.OperationType.AC).Execute(DisplayText);
                  }
            );
            ...
            (
                  () =>
                  {
                      DisplayText = keyCMD.OperationRegistry.GetOperation(keyCMD.OperationType.Back).Execute(DisplayText);
                  }
            );
            ...
            (
                  () =>
                  {
                      DisplayText = keyCMD.OperationRegistry.GetOperation(keyCMD.OperationType.Percentage).Execute(DisplayText);
                  }
            );
